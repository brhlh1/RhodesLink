...
class ChatRepository(private val wrapper: DatabaseWrapper, settings: SettingsRepository? = null) {
    ...
    suspend fun failMemorySource(id: Long, token: String, error: String) = memoryV2.failSource(id, token, error)
    ...
    suspend fun restoreExpiredMemoryItems(expiresAt: Long, updatedAt: Long) = memoryV2.restoreExpiredMemoryItems(expiresAt, updatedAt)
